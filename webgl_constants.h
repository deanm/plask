...
WEBGL_CONSTANTS_EACH(QUERY_COUNTER_BITS_EXT, 0x8864)
WEBGL_CONSTANTS_EACH(CURRENT_QUERY_EXT, 0x8865)
WEBGL_CONSTANTS_EACH(QUERY_RESULT_EXT, 0x8866)
WEBGL_CONSTANTS_EACH(QUERY_RESULT_AVAILABLE_EXT, 0x8867)
WEBGL_CONSTANTS_EACH(TIME_ELAPSED_EXT, 0x88BF)
WEBGL_CONSTANTS_EACH(TIMESTAMP_EXT, 0x8E28)
WEBGL_CONSTANTS_EACH(GPU_DISJOINT_EXT, 0x8FBB)
...
WEBGL_CONSTANTS_EACH(FRAMEBUFFER_SRGB, 0x8DB9)
#endif
...
WEBGL_PARAMS_EACH(TIMESTAMP_EXT, GLuint64)
WEBGL_PARAMS_EACH(GPU_DISJOINT_EXT, GLboolean)
#endif
#endif
